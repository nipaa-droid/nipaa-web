import { OsuBeatmap, OsuDroidScore, OsuDroidUser, Prisma, SubmissionStatus, } from "@prisma/client";
import { Accuracy, MapInfo, MapStats, Mod, ModHidden, rankedStatus, } from "@rian8337/osu-base";
